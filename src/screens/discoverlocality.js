        ...
        <ScrollView>
          ...
          <View style={{marginLeft: wp(10), marginTop: hp(3)}}>
            <View style={{flexDirection: 'row'}}>
              <TouchableOpacity>
                <Image
                  source={require('../utils/assets/Svg/agra.svg')}
                  style={{
                    resizeMode: 'contain',
                    height: hp(13),
                    width: wp(23),
              ...
              <TouchableOpacity>
                <Image
                  source={require('../utils/assets/Svg/noida.svg')}
                  style={{
                    resizeMode: 'contain',
                    height: hp(13),
                    width: wp(23),
              ...
              <TouchableOpacity>
                <Image
                  source={require('../utils/assets/Svg/delhi.svg')}
                  style={{
                    resizeMode: 'contain',
                    height: hp(13),
                    width: wp(23),
            ...
            <View style={{flexDirection: 'row', marginTop: hp(3)}}>
              <Image
                source={require('../utils/assets/Svg/mumbai.svg')}
                style={{
                  resizeMode: 'contain',
                  height: hp(13),
                  width: wp(23),
              ...
              />
              <Image
                source={require('../utils/assets/Svg/ahmedabad.svg')}
                style={{
                  resizeMode: 'contain',
                  height: hp(13),
                  width: wp(23),
              ...
              />
              <Image
                source={require('../utils/assets/Svg/chennai.svg')}
                style={{
                  resizeMode: 'contain',
                  height: hp(13),
                  width: wp(23),
            ...
            <View style={{flexDirection: 'row', marginTop: hp(3)}}>
              <Image
                source={require('../utils/assets/Svg/pune.svg')}
                style={{
                  resizeMode: 'contain',
                  height: hp(13),
                  width: wp(23),
              ...
              />
              <Image
                source={require('../utils/assets/Svg/bangalore.svg')}
                style={{
                  resizeMode: 'contain',
                  height: hp(13),
                  width: wp(23),
              ...
              />
              <Image
                source={require('../utils/assets/Svg/kolkatta.svg')}
                style={{
                  resizeMode: 'contain',
                  height: hp(13),
                  width: wp(23),
