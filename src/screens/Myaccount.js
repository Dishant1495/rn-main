      ...
      <View style={{backgroundColor: '#FFFFFF', height: '100%'}}>
        <ScrollView>
          ...
          <View
            ...
            <Image
              source={require('../utils/assets/Image/cameralogo.png')}
              style={{
                height: 80,
                marginTop: hp(3),
                resizeMode: 'contain',
            ...
            <TouchableOpacity>
              <View
                ...
                <Image
                  source={require('../utils/assets/Image/photo_camera.png')}
          ...
          <Text style={{textAlign: 'center', fontSize: 12, color: '#532280'}}>
            Herobruh9447@gmail.com
          </Text>
          <Text
            style={{
              textAlign: 'center',
          ...
          <View style={{marginLeft: wp(10), marginTop: hp(8)}}>
            <TouchableOpacity onPress={() => navigation.navigate('Myschool_a')}>
              <View style={{flexDirection: 'row'}}>
                <Image
                  source={require('../utils/assets/Svg/my-school.svg')}
            ...
            <View style={{flexDirection: 'row', marginTop: hp(2.5)}}>
              <Image
                source={require('../utils/assets/Svg/sign-out.svg')}
                style={{height: 25, width: 25, resizeMode: 'contain'}}
              />
              <Text
                style={{
