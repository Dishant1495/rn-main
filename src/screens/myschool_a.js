    ...
    return (
      <View style={{backgroundColor: '#FFFFFF', height: '100%'}}>
        <ScrollView>
          ...
          <Image
            source={require('../utils/assets/Image/illustrationMySchool.png')}
            style={{
              height: 205,
              width: 285,
              alignSelf: 'center',
          ...
          <View
            ...
            <Text style={{marginLeft: wp(10), marginTop: hp(4)}}>
              No school selected for enquiry yet, Explore Schools for enquiry.
            </Text>
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('Myschool_b')}>
                <View
                  style={{
