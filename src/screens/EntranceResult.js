...
class EntranceResult extends Component {
  constructor(props) {
    super(props);
    this.state = {
      modalVisible: false,
            ...
            <View style={styles.modalView}>
              <View
                ...
                <Image
                  ...
                  source={require('../utils/assets/Image/wait.png')}
                />
                ...
                <Text
                  ...
                  Good thing takes time, All the best for Result.
                </Text>
                ...
                <TouchableHighlight
                  ...
                  <Text style={styles.textStyle}>Update Soon</Text>
                </TouchableHighlight>
              </View>
            </View>
          </View>
