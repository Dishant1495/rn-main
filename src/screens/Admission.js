      ...
      <View style={{height: '100%', backgroundColor: '#FFFFFF'}}>
        <ScrollView>
          ...
          <View style={{marginLeft: wp(10)}}>
            ...
            <Text style={{color: '#451D6A', marginTop: hp(4), fontSize: 18}}>
              Admission Process
            </Text>
            ...
            <Text style={{color: '#9B3189', marginTop: 15, fontSize: 15}}>
              1- Apply for Admission.
            </Text>
            <Text style={{color: '#9B3189', marginTop: 8, fontSize: 15}}>
