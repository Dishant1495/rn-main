...
export default class Getfeestructure extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <View
        ...
        <View
          ...
          <LinearGradient
            ...
            <Image
              source={require('../utils/assets/Image/longfeeback.png')}
            ...
            <TouchableOpacity
              onPress={() =>
                ...
                // this.props.navigation.navigate('Getfeestructurewithoutlogin')
              }>
