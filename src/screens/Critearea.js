      ...
      <View style={{height: '100%', backgroundColor: '#FFFFFF'}}>
        <ScrollView>
          ...
          <View style={{marginLeft: wp(10)}}>
            ...
            <Text style={{color: '#451D6A', marginTop: hp(4), fontSize: 20}}>
              Admission Criteria
            </Text>
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              <Text
                style={{color: '#9B3189', marginTop: hp(2.5), fontSize: 15}}>
                {' '}
                Entrance Test.
              </Text>
            </View>
            ...
            <Text style={{color: '#9B3189', marginTop: hp(3), fontSize: 15}}>
              {' '}
              1- Birth Certificate
            </Text>
            <Text style={{color: '#9B3189', marginTop: hp(1.5), fontSize: 15}}>
              {' '}
              2- Aadhar Card/Passport
            </Text>
            <Text style={{color: '#9B3189', marginTop: hp(1.5), fontSize: 15}}>
              {' '}
              3- Progress Report of Previous class (Class I upwards)
            </Text>
            <Text style={{color: '#9B3189', marginTop: hp(1.5), fontSize: 15}}>
              {' '}
              4- Two latest passport size-coloured photographs (Parents)
            </Text>
            <Text style={{color: '#9B3189', marginTop: hp(1.5), fontSize: 15}}>
              {' '}
              5- Five latest passport size-coloured photographs (Student)
            </Text>
            <Text style={{color: '#9B3189', marginTop: hp(1.5), fontSize: 15}}>
              {' '}
              6- Transfer Certificate (from Class I onwards)
            </Text>
            ...
            <Text style={{color: '#9B3189', marginTop: hp(3.5), fontSize: 15}}>
              {' '}
              1- Pre Nursery: 2+ years as on 1st April of the year seeking
              admission.
            </Text>

            <Text style={{color: '#9B3189', marginTop: hp(2.5), fontSize: 15}}>
              {' '}
              2- Nursery: 3+ years as on 1st April of the year seeking
              admission.
            </Text>

            <Text style={{color: '#9B3189', marginTop: hp(2.5), fontSize: 15}}>
              {' '}
              3- KG: 4+ years as on 1st April of the year seeking admission.
            </Text>
            ...
            <Text
              ...
              {' '}
              4- Class I: 4+ years as on 1st April of the year seeking
              admission.
            </Text>
          </View>
        </ScrollView>
