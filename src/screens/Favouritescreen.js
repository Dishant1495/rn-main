    ...
    return (
      <View style={{backgroundColor: '#FFFFFF', height: '100%'}}>
        <ScrollView>
          ...
          <Image
            source={require('../utils/assets/Svg/homefavourite.svg')}
            style={{
              height: 205,
              width: 285,
              alignSelf: 'center',
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                You added 3 Schools in you favourite list.{' '}
              </Text>

              <View>
                <Image
                  source={require('../utils/assets/Svg/favouriteheart.svg')}
                  style={{right: 10, marginTop: hp(2)}}
                />
                <Text
                  style={{
                    color: 'white',
            ...
            <View>
              <FlatList
                style={{marginTop: hp(1), marginBottom: 15, marginLeft: wp(4)}}
                horizontal={true}
                      ...
                      <View
                        ...
                        <View style={{flexDirection: 'row'}}>
                          <View
                            ...
                            <Text
                              style={{color: '#9B3189', fontWeight: 'bold'}}>
                              CBSE
                            </Text>
                          </View>
                          <View
