...
export default class Onlineoverview extends Component {
  constructor(props) {
    super(props);
    this.state = {
      textstyle: false,
          ...
          <View style={{marginLeft: wp(10)}}>
            ...
            <View
              ...
              <Text
                ...
                diam nonummy nibh euismod tincidunt ut laoreet t dolore magna
              </Text>
            </View>
            ...
            <View style={{flexDirection: 'row', marginTop: hp(-2)}}>
              <View style={{flexDirection: 'row', marginTop: hp(2.5)}}>
                <Image
                  source={require('../utils/assets/Image/onlinegreenlogo.png')}
                  style={{marginRight: wp(2.5)}}
                />
                <Image
                  source={require('../utils/assets/Image/offlinebluelogo.png')}
                />
              </View>
              <View
                style={{
            ...
            <View style={{flexDirection: 'row', marginTop: hp(2.5)}}>
              <ScrollView
                ...
                <View
                  ...
                  <Image
                    source={require('../utils/assets/Image/girlboys.png')}
                    style={{
                      resizeMode: 'contain',
                      alignSelf: 'center',
                      height: hp(15),
                  ...
                  <Text style={{color: '#451D6A', alignSelf: 'center'}}>
                    Students
                  </Text>
                </View>
                ...
                <View
                  ...
                  <Image
                    source={require('../utils/assets/Svg/standard.svg')}
                    style={{
                      resizeMode: 'contain',
                      alignSelf: 'center',
                      height: hp(8),
                ...
                <View
                  ...
                  <Image
                    source={require('../utils/assets/Svg/seats-left.svg')}
                    style={{
                      resizeMode: 'contain',
                      alignSelf: 'center',
                      height: hp(8),
            ...
            <Text style={{color: '#451D6A', fontSize: 20, marginTop: hp(3)}}>
              About School
            </Text>
            ...
            <Text
              ...
              K.R. Mangalam World School Greater Noida Branch, a new milestone
              added in the legacy of the KRM brand stands tall for reputed value
              systems and xyzzzzzzzz zzzxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxzz see
              more.....
            </Text>
            ...
            <View>
              <View style={{flexDirection: 'row'}}>
                <View style={{flexDirection: 'row', marginTop: hp(2)}}>
                  <Image
                    source={require('../utils/assets/Svg/tick.svg')}
