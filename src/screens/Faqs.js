            ...
            <View style={{ height: '100%', backgroundColor: '#FFFFFF' }}>
                <ScrollView>
                    ...
                    <View style={{ marginLeft: wp(10) }}>
                            ...
                            <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                                ...
                                <View style={{ flexDirection: 'column' }}>
                                    <TouchableOpacity onPress={() => navigation.navigate('Faqs')}>
                                        ...
                                        <Text style={{ color: '#9B3189', fontSize: 15, marginRight: 15, fontWeight: 'bold' }}>FAQs</Text>

                                    </TouchableOpacity>
                                    <View style={{ backgroundColor: '#9B3189', height: 3, width: 35, marginTop: 3 }}>
                        ...
                        <Text style={{ color: '#451D6A', marginTop: hp(4), fontSize: 17 }}>Question in your mind</Text>

                        <View style={{ backgroundColor: '#F2F3FA', height: 50, width: '90%', marginTop: hp(3), borderRadius: 10, flexDirection: 'row' }}>
                            <Text style={{ color: '#9B3189', fontWeight: 'bold', marginTop: 15, marginLeft: 15,fontSize:14 }}>Which board is this school affiliated to?</Text>
                            <Image source={require('../utils/assets/Image/downringani.png')} style={{ resizeMode: 'contain', right: 15, position: 'absolute', height: 14, width: 14, marginTop: 15 }} />
                        </View>

                        <View style={{ backgroundColor: '#FFFFFF', height: 100, marginTop: hp(-0.5), width: '90%', shadowColor: 'black', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0, shadowRadius: 2, elevation: 7 }}>
                            <Text style={{ color: '#9B3189', marginTop: 10, alignSelf: 'center', marginLeft: 5 }}> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud </Text>
                        </View>

                        <View style={{ backgroundColor: '#F2F3FA', height: 50, width: '90%', marginTop: hp(2), borderRadius: 10, flexDirection: 'row' }}>
                            <Text style={{ color: '#9B3189', fontWeight: 'bold', marginTop: 15, marginLeft: 15,fontSize:14 }}>Does this school offer Hostel facility?</Text>
                            <Image source={require('../utils/assets/Image/downringani.png')} style={{ resizeMode: 'contain', right: 15, position: 'absolute', height: 14, width: 14, marginTop: 15 }} />
                        </View>


                        <View style={{ backgroundColor: '#F2F3FA', height: 50, width: '90%', marginTop: hp(2), borderRadius: 10, flexDirection: 'row' }}>
                            <Text style={{ color: '#9B3189', fontWeight: 'bold', marginTop: 15, marginLeft: 15,fontSize:14 }}>What facility are available in this school?</Text>
                            <Image source={require('../utils/assets/Image/downringani.png')} style={{ resizeMode: 'contain', right: 15, position: 'absolute', height: 14, width: 14, marginTop: 15 }} />
                        </View>


                        <View style={{ backgroundColor: '#F2F3FA', height: 50, width: '90%', marginTop: hp(2), borderRadius: 10, flexDirection: 'row' }}>
                            <Text style={{ color: '#9B3189', fontWeight: 'bold', marginTop: 15, marginLeft: 15,fontSize:14 }}>Is this school co-educational?</Text>
                            <Image source={require('../utils/assets/Image/downringani.png')} style={{ resizeMode: 'contain', right: 15, position: 'absolute', height: 14, width: 14, marginTop: 15 }} />
                        </View>

                        <View style={{ backgroundColor: '#F2F3FA', height: 50, width: '90%', marginBottom: 45, marginTop: hp(2), borderRadius: 10, flexDirection: 'row' }}>
                            <Text style={{ color: '#9B3189', fontWeight: 'bold', marginTop: 15, marginLeft: 15,fontSize:14 }}>Can I study Online from Home?</Text>
                            <Image source={require('../utils/assets/Image/downringani.png')} style={{ resizeMode: 'contain', right: 15, position: 'absolute', height: 14, width: 14, marginTop: 15 }} />
                        </View>
